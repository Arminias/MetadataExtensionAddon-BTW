...
public abstract class World implements IBlockAccess
{
    ...
    public int getBlockExtraMetadata(int par1, int par2, int par3)
    {
        if (par1 >= -30000000 && par3 >= -30000000 && par1 < 30000000 && par3 < 30000000)
        {
            ...
            else
            {
                ...
                par1 &= 15;
                par3 &= 15;
                return var4.getBlockExtraMetadata(par1, par2, par3);
            }
        }
        else
        {
     ...
     * Bit 4 seems to prevent a render update when called on client
     */
    public boolean setBlockExtraMetadata(int par1, int par2, int par3, int par4, int par5)
    {
        if (par1 >= -30000000 && par3 >= -30000000 && par1 < 30000000 && par3 < 30000000)
        {
            if (par2 < 0)
            ...
            else
            {
                ...
                int var7 = par1 & 15;
                int var8 = par3 & 15;
                boolean var9 = var6.setBlockExtraMetadata(var7, par2, var8, par4);
    ...
    */
    ...
    //EDIT
    public boolean SetBlockExtraMetadataWithNotify( int i, int j, int k, int iMetadata, int iNotifyBitField )
    {
        // client
        //return setBlockExtraMetadataWithNotify( i, j, k, iMetadata, iNotifyBitField );
        // server
        return setBlockExtraMetadata( i, j, k, iMetadata, iNotifyBitField );
    }

    //EDIT
    public boolean setBlockExtraMetadata( int i, int j, int k, int iMetadata )
    {
        return this.setBlockExtraMetadata( i, j, k, iMetadata, 0 );
    }

    //EDIT
    public boolean setBlockExtraMetadataWithNotify( int i, int j, int k, int iMetadata )
    {
        return this.setBlockExtraMetadata( i, j, k, iMetadata, 3 );
    }

    //EDIT
    public boolean setBlockExtraMetadataWithClient( int i, int j, int k, int iMetadata )
    {
        return this.setBlockExtraMetadata( i, j, k, iMetadata, 2 );
    }

    //EDIT
    public boolean setBlockExtraWithNotifyNoClient( int i, int j, int k, int iMetadata )
    {
        return this.setBlockExtraMetadata( i, j, k, iMetadata, 1 );
    }
