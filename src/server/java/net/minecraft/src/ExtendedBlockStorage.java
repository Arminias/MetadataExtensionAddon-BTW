...
public class ExtendedBlockStorage
{
    ...
    //EDIT
    /**
     * Stores the extra metadata associated with blocks in this ExtendedBlockStorage.
     */
    ...
    //EDIT
    /**
     * Sets the HunkArray of block extra metadata (blockExtraMetadataArray) for this ExtendedBlockStorage.
     */
    public void setBlockExtraMetadataArray(HunkArray par1HunkArray)
    {
        ...
        if (par1HunkArray.data.length == 0) {
            // But only if there is actual data
