...
public class TileEntity
{
    ...
    */
    ...
    public int getBlockExtraMetadata()
    {
        ...
        {
            this.blockExtraMetadata = this.worldObj.getBlockExtraMetadata(this.xCoord, this.yCoord, this.zCoord);
        }
    ...
    /**
     * Causes the TileEntity to reset all it's cached values for it's container block, blockID, metaData,
     * extra metaData and in the case of chests, the adjacent chest check
     */
