...
public class NetClientHandler extends NetHandler
{
        ...
        if (par1Packet52MultiBlockChange.metadataArray != null)
        {
            ...
            try
            {
                for (int var5 = 0; var5 < par1Packet52MultiBlockChange.size; ++var5)
                {
                    ...
                    this.worldClient.setBlockAndMetadataAndExtraMetadataAndInvalidate(var10 + var2, var12, var11 + var3, var8, var9, extraMeta);
                }
            }
    ...
    {
        //EDIT
        this.worldClient.setBlockAndMetadataAndExtraMetadataAndInvalidate(packet.xPosition, packet.yPosition, packet.zPosition, packet.type, packet.metadata, packet.extraMetadata);
    }
