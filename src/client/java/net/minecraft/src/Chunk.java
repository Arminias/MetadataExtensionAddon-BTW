...
public class Chunk
{
    ...
    public boolean setBlockIDWithMetadata(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                //EDIT
                var10.setExtBlockExtraMetadata(par1, par2 & 15, par3, 0);
    ...
    public boolean setBlockExtraMetadata(int par1, int par2, int par3, int par4)
    {
        ...
        {
            int var6 = var5.getExtBlockExtraMetadata(par1, par2 & 15, par3);
            ...
            {
                this.isModified = true;
                var5.setExtBlockExtraMetadata(par1, par2 & 15, par3, par4);
                int var7 = var5.getExtBlockID(par1, par2 & 15, par3);
    ...
    public void fillChunk(byte[] par1ArrayOfByte, int par2, int par3, boolean par4)
    {
        ...
        for (var7 = 0; var7 < this.storageArrays.length; ++var7)
        {
            if ((par2 & 1 << var7) != 0 && this.storageArrays[var7] != null)
            {
                var9_2 = this.storageArrays[var7].getExtraMetadataArray();
